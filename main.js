...
if(!el)return;
var txt=lang==="vi"
?"Thông thường, mỗi Chủ nhật chúng tôi tổ chức buổi bán hàng trực tiếp tại cửa hàng em Hanoi (12:00–16:00), đóng gói rau tại đó và giao qua Grab. Bạn cũng có thể nhận hàng trực tiếp tại cửa hàng. Những ngày không có buổi bán trực tiếp, hàng sẽ được gửi từ nông trại theo thứ tự."
:lang==="en"
?"Normally, every Sunday we hold a direct sales event at em Hanoi store (12:00–16:00), where we pack the vegetables and deliver via Grab. Pickup at the store is also available. On days without a direct sales event, orders will be shipped from the farm in sequence."
